    ...
    <div className="bg-dark text-light px-5 pt-4">
      <div className="row">
        ...
        <div className="col-lg-3 col-md-3   text-start mb-sm-3">
          ...
          <p>
            <i className="fas fa-envelope"></i> E-mail: greenlife@gmail.com
          </p>
          <p>
            <i className="fas fa-location-arrow"></i> West-Agargaon, 222/3, Siam
            Monjil, 3B 3rd Floor
          </p>
          <p>
        ...
        <div className="col-lg-3 col-md-3  ">
          ...
          <input
            ...
            name=""
            id=""
            className="bg-dark text-light border-0 p-3"
        ...
        <p className="p-3 text-secondary">
          @2023 Copyright allright reserved AK & Green Life Hospital{" "}
        </p>
      </div>
    </div>
  );
